...
export function App() {
  ...
  const handlePurpleButtonClick = () => {
    setIsPurple(true);
    setAnnouncement("The color purple Added to the Trafic Light!");
  ...
  return (
    <>
      ...
      <div className="button-container">
          ...
          <button onClick={handleButtonClick} className="button-div secondary margin-1">
            Alternate Color
           </button>
           <div>
              <button onClick={handlePurpleButtonClick} className="button-div secondary margin-1">
                 Add Purple
